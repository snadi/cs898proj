...
such a system, \textit{Consentir}, where patient information and consent policies as well as other access policies are represented in Notation 3 (N3). A
reasoning engine,
...
To address these problems, we build \textit{Consentir}, a policy based (rule based) patient consent management system. The system would utilize (previously
...
deny rule for every possible situation will result in an explosion in the number of rules. In such a sensitive area such as patient privacy, balancing those
